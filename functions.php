...
function irf_enqueue_scripts() {
    ...
    wp_enqueue_style('irf-main', get_template_directory_uri() . '/assets/css/main.css', array(), '2.5');
    wp_enqueue_style('irf-style', get_stylesheet_uri(), array('irf-main'), '2.5');
    wp_enqueue_script('irf-main', get_template_directory_uri() . '/assets/js/main.js', array(), '2.5', true);
}
    ...
    acf_add_local_field_group(array(
        ...
        'fields'   => array(
            ...
            array(
                ...
                'button_label' => 'Add Slide',
                'sub_fields'   => array(
                    array('key' => 'field_rp_rb_badge',    'label' => 'Badge Text',    'name' => 'rb_badge',    'type' => 'text',     'placeholder' => 'e.g. Proven Track Record', 'wrapper' => array('width' => '50')),
                    array('key' => 'field_rp_rb_title',    'label' => 'Headline',      'name' => 'rb_title',    'type' => 'text',     'instructions' => 'Use \\n for a line break', 'wrapper' => array('width' => '50')),
                    array('key' => 'field_rp_rb_subtitle', 'label' => 'Subtitle',      'name' => 'rb_subtitle', 'type' => 'textarea', 'rows' => 2),
                    array('key' => 'field_rp_rb_s1n', 'label' => 'Stat 1 Number', 'name' => 'rb_stat1_num', 'type' => 'text', 'wrapper' => array('width' => '20')),
                    array('key' => 'field_rp_rb_s1s', 'label' => 'Suffix',        'name' => 'rb_stat1_sfx', 'type' => 'text', 'wrapper' => array('width' => '10'), 'placeholder' => '+'),
                    array('key' => 'field_rp_rb_s1l', 'label' => 'Stat 1 Label',  'name' => 'rb_stat1_lbl', 'type' => 'text', 'wrapper' => array('width' => '20')),
                    array('key' => 'field_rp_rb_s2n', 'label' => 'Stat 2 Number', 'name' => 'rb_stat2_num', 'type' => 'text', 'wrapper' => array('width' => '20')),
                    array('key' => 'field_rp_rb_s2s', 'label' => 'Suffix',        'name' => 'rb_stat2_sfx', 'type' => 'text', 'wrapper' => array('width' => '10'), 'placeholder' => '+'),
                    array('key' => 'field_rp_rb_s2l', 'label' => 'Stat 2 Label',  'name' => 'rb_stat2_lbl', 'type' => 'text', 'wrapper' => array('width' => '20')),
                    array('key' => 'field_rp_rb_s3n', 'label' => 'Stat 3 Number', 'name' => 'rb_stat3_num', 'type' => 'text', 'wrapper' => array('width' => '20')),
                    array('key' => 'field_rp_rb_s3s', 'label' => 'Suffix',        'name' => 'rb_stat3_sfx', 'type' => 'text', 'wrapper' => array('width' => '10'), 'placeholder' => '+'),
                    array('key' => 'field_rp_rb_s3l', 'label' => 'Stat 3 Label',  'name' => 'rb_stat3_lbl', 'type' => 'text', 'wrapper' => array('width' => '20')),
                    array(
                        'key'           => 'field_rp_rb_fx',
                        'label'         => 'Transition Effect',
                        'name'          => 'rb_fx',
                        'type'          => 'select',
                        'choices'       => array('diagonal' => 'Diagonal', 'iris' => 'Iris', 'slide-x' => 'Slide X', 'slide-y' => 'Slide Y', 'cube' => 'Cube', 'zoom-fade' => 'Zoom Fade'),
                        'default_value' => 'diagonal',
                        'wrapper'       => array('width' => '25'),
                    ),
                    array(
                        'key'           => 'field_rp_rb_theme',
                        'label'         => 'Color Theme',
                        'name'          => 'rb_theme',
                        'type'          => 'select',
                        'choices'       => array('dark-red' => 'Dark Red', 'dark-purple' => 'Dark Purple', 'dark-teal' => 'Dark Teal'),
                        'default_value' => 'dark-red',
                        'wrapper'       => array('width' => '25'),
                    ),
                    array(
                        'key'           => 'field_rp_rb_deco',
                        'label'         => 'Decoration',
                        'name'          => 'rb_decoration',
                        'type'          => 'select',
                        'choices'       => array('none' => 'None', 'trophy' => 'Trophy', 'year-highlight' => 'Year Highlight', 'exam-pills' => 'Exam Pills'),
                        'default_value' => 'none',
                        'wrapper'       => array('width' => '25'),
                    ),
                    array(
                        ...
                        'instructions'  => 'Upload a background photo. If left empty, the selected Color Theme gradient is used instead.',
                        'wrapper'       => array('width' => '25'),
                    ),
                ),
            ),
