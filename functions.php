...
function irf_register_acf_fields() {
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            ...
            array('key' => 'field_header_cta_tab',       'label' => 'Header CTA Button',      'name' => '',                       'type' => 'tab'),
            array('key' => 'field_header_mock_btn_text', 'label' => 'Button Text',             'name' => 'header_mock_btn_text',    'type' => 'text', 'default_value' => 'Mock Test', 'wrapper' => array('width' => '40'), 'instructions' => 'Leave blank to hide the button.'),
            array('key' => 'field_header_mock_btn_url',  'label' => 'Button Link (URL)',        'name' => 'header_mock_btn_url',     'type' => 'url',  'default_value' => '#',          'wrapper' => array('width' => '60')),
    ...
    acf_add_local_field_group(array(
        ...
        'fields'   => array(
            ...
            array(
                ...
                'sub_fields'   => array(
                    array(
                        'key'          => 'field_rp_rs_batch',
                        'label'        => 'Batch',
                        'name'         => 'rs_batch_name',
                        'type'         => 'text',
                        'placeholder'  => 'e.g. Batch 1',
                        'instructions' => 'Must match Batch Name entered in the "Batch Results" tab',
                    ...
                    array(
                        'key'          => 'field_rp_rs_extra_exams',
                        'label'        => 'Extra Exams',
                        'name'         => 'rs_extra_exams',
                        'type'         => 'text',
                        'instructions' => 'Comma-separated, e.g. IBPS PO, SBI Clerk',
                        'placeholder'  => 'e.g. IBPS PO, SBI Clerk',
                        'wrapper'      => array('width' => '20'),
                    ),
                ),
            ),
            ...
            /* ── TAB: Batch Results ── */
            array('key' => 'field_rp_tab_batches', 'label' => 'Batch Results', 'name' => '', 'type' => 'tab'),
            array(
                'key'          => 'field_rp_batches',
                'label'        => 'Batch Definitions',
                'name'         => 'results_batches',
                'type'         => 'repeater',
                'instructions' => 'Define each batch. "Batch Name" must exactly match the Batch field you enter in Student rows.',
                'min'          => 0,
                'layout'       => 'table',
                'button_label' => 'Add Batch',
                'sub_fields'   => array(
                    array(
                        'key'         => 'field_rp_rb_year',
                        'label'       => 'Year',
                        'name'        => 'rb_year',
                        'type'        => 'text',
                    ...
                    array(
                        'key'          => 'field_rp_rb_name',
                        'label'        => 'Batch Name',
                        'name'         => 'rb_batch_name',
                        'type'         => 'text',
                        'placeholder'  => 'e.g. Batch 1',
                        'instructions' => 'Must match the Batch field in Student rows exactly',
                        'wrapper'      => array('width' => '18'),
                    ),
                    array(
                        'key'         => 'field_rp_rb_label',
                        'label'       => 'Date Range',
                        'name'        => 'rb_batch_label',
                        'type'        => 'text',
                    ...
                    array(
                        'key'          => 'field_rp_rb_total',
                        'label'        => 'Total Enrolled',
                        'name'         => 'rb_total_students',
                        'type'         => 'number',
                        'placeholder'  => 'e.g. 400',
                        'instructions' => 'Total students enrolled — used for 385/400 success ratio',
                        'wrapper'      => array('width' => '15'),
                    ),
                ),
            ),
