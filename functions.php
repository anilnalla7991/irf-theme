...
function irf_enqueue_scripts() {
    ...
    wp_enqueue_style('irf-main', get_template_directory_uri() . '/assets/css/main.css', array(), '1.5');
    wp_enqueue_style('irf-style', get_stylesheet_uri(), array('irf-main'), '1.5');
    wp_enqueue_script('irf-main', get_template_directory_uri() . '/assets/js/main.js', array(), '1.5', true);
}
